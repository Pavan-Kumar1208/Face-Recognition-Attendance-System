...
def takeAttendence(request):
    ...
    # folder for attendences and csv file
            ...
            p_dir = "C:/Users/navee/Desktop/Projects/face_recognition_attendance_system-master/face_recognition_attendance_system-master/Attendances"
            path1 = os.path.join(p_dir, directory)
    ...
    # ---------------------------------------------------
        #  Sending the attendance to email
            ...
            filename = "C:/Users/navee/Desktop\Projects/face_recognition_attendance_system-master/face_recognition_attendance_system-master/Attendances{}/{}-{}-{}-{}-{}P.csv".format(current_date,current_date,details['branch'],details['year'],details['section'],details['period'])
